...
def get_path_to_scan_dir(config):
    return os.path.join(global_paths.output_dir, config.sim_tag, config.scan_tag)
 
def get_path_to_recon_dir(config):
    return os.path.join(global_paths.output_dir, config.sim_tag, config.recon_tag)
